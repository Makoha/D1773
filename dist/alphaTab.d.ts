...
declare class Color {
     ...
     * @target web
     */
    static fromJson(json: unknown): Color | null;
    /**
     * @target web
     */
    static toJson(obj: Color): unknown;
}
...
declare class Font {
     ...
     * @target web
     */
    static fromJson(value: unknown): Font | null;
    /**
     * @target web
     */
    static toJson(font: Font): unknown;
}
...
declare class Settings {
     ...
     * @target web
     */
    static toJson(settings: Settings): unknown;
    /**
     * @target web
     */
     ...
     * @target web
     */
    fillFromDataAttributes(dataAttributes: Map<string, unknown>): void;
    /**
...
declare class MidiEvent {
     ...
     */
    constructor(tick: number, status: number, data1: number, data2: number);
    /**
...
declare class PositionChangedEventArgs {
     ...
     */
    constructor(currentTime: number, endTime: number, currentTick: number, endTick: number);
}
...
declare class Automation {
    ...
    static copyTo(src: Automation, dst: Automation): void;
    clone(): Automation;
}
...
declare class BendPoint {
    ...
    static copyTo(src: BendPoint, dst: BendPoint): void;
    clone(): BendPoint;
}
...
declare class Fermata {
     ...
     */
    length: number;
    static copyTo(src: Fermata, dst: Fermata): void;
}
...
declare class RenderStylesheet {
    ...
    static copyTo(src: RenderStylesheet, dst: RenderStylesheet): void;
}
...
declare class PlaybackInformation {
     ...
     */
    isSolo: boolean;
    static copyTo(src: PlaybackInformation, dst: PlaybackInformation): void;
}
...
declare class InstrumentArticulation {
    ...
    constructor(staffLine?: number, outputMidiNumber?: number, noteHeadDefault?: MusicFontSymbol, noteHeadHalf?: MusicFontSymbol, noteHeadWhole?: MusicFontSymbol, techniqueSymbol?: MusicFontSymbol, techniqueSymbolPlacement?: TextBaseline);
    static copyTo(src: any, dst: InstrumentArticulation): void;
...
declare class Track {
    ...
    static copyTo(src: Track, dst: Track): void;
...
declare class Score {
    ...
    static copyTo(src: Score, dst: Score): void;
...
declare class Section {
     ...
     */
    text: string;
    static copyTo(src: Section, dst: Section): void;
}
...
declare class MasterBar {
     ...
     */
    isAnacrusis: boolean;
    static copyTo(src: MasterBar, dst: MasterBar): void;
    /**
...
declare class Voice {
     ...
     */
    isEmpty: boolean;
    static copyTo(src: Voice, dst: Voice): void;
    insertBeat(after: Beat, newBeat: Beat): void;
    addBeat(beat: Beat): void;
    private chain;
    addGraceBeat(beat: Beat): void;
    getBeatAtDisplayStart(displayStart: number): Beat | null;
    finish(settings: Settings): void;
...
declare class Bar {
    ...
    get isEmpty(): boolean;
    static copyTo(src: Bar, dst: Bar): void;
...
declare class Staff {
    ...
    static copyTo(src: Staff, dst: Staff): void;
    finish(settings: Settings): void;
...
declare class Chord {
    ...
    static copyTo(src: Chord, dst: Chord): void;
}
...
declare class Note {
    ...
    static copyTo(src: Note, dst: Note): void;
    clone(): Note;
...
declare class ScoreLoader {
    ...
    private static getBytesFromString;
    /**
...
declare class SystemExclusiveEvent extends SystemCommonEvent {
    ...
    constructor(delta: number, status: number, id: number, data: Uint8Array);
    writeTo(s: IWriteable): void;
}
...
declare class JsonConverter {
    ...
    private static tracksToJsObject;
    private static stavesToJsObject;
    private static barsToJsObject;
    private static voicesToJsObject;
    private static beatsToJsObject;
    private static notesToJsObject;
    private static masterBarsToJsObject;
    /**
    ...
    private static jsObjectToTracks;
    private static jsObjectToStaves;
    private static jsObjectMapForEach;
    private static jsObjectToBars;
    private static jsObjectToVoices;
    private static jsObjectToBeats;
    private static jsObjectToNotes;
    private static jsObjectToMasterBars;
...
declare class Tuning {
     ...
     */
    constructor(name: string, tuning: number[], isStandard: boolean);
}
...
declare class BarLayoutingInfo {
    ...
    addSpring(start: number, duration: number, preSpringSize: number, postSpringSize: number): Spring;
    addBeatSpring(beat: Beat, preBeatSize: number, postBeatSize: number): Spring;
    finish(): void;
    ...
    calculateWidth(force: number, springConstant: number): number;
...
declare class ChordDiagramContainerGlyph extends GlyphGroup {
...
declare class TuningGlyph extends GlyphGroup {
    private _scale;
    private _resources;
    height: number;
    constructor(x: number, y: number, scale: number, resources: RenderingResources, tuning: Tuning);
...
declare abstract class ScoreLayout {
    ...
    protected tuningGlyph: TuningGlyph | null;
